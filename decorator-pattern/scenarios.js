...
const { MonitoredEncounter, RelaxedEncounter } = require("./modifiers.js")
...
class ScenarioOutsideCell extends Scenario {
    constructor() {
        super();
        this.npc = new MonitoredEncounter(new Dwarf("Jhonny the dwarf"))
    }
    run() {
...
class ScenarioOutsideCellRelaxed extends Scenario {
    constructor() {
        super();
        this.npc = new MonitoredEncounter(new RelaxedEncounter(new Dwarf("Jhonny the dwarf")));
    }
    run() {
        console.log(this.npc.encounter())
